 ...
 */
MapTo('bootcamp-isabelle/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('bootcamp-isabelle/components/separator')(SeparatorV1Component);

MapTo('bootcamp-isabelle/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('bootcamp-isabelle/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('bootcamp-isabelle/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('bootcamp-isabelle/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('bootcamp-isabelle/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('bootcamp-isabelle/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('bootcamp-isabelle/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('bootcamp-isabelle/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('bootcamp-isabelle/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('bootcamp-isabelle/components/accordion')(AccordionV1Component);
MapTo('bootcamp-isabelle/components/tabs')(TabsV1Component);
...
LazyMapTo('bootcamp-isabelle/components/teaser')(TeaserV1Component);
...
LazyMapTo('bootcamp-isabelle/components/carousel')(CarouselV1Component);
...
LazyMapTo('bootcamp-isabelle/components/text')(LazyTextModule, TextEditConfig);