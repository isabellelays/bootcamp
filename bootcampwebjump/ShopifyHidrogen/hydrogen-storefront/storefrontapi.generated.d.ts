...
export type DashboardShopifyQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type DashboardShopifyQuery = {
  products: {
    nodes: Array<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query DashboardShopify {\n    products(first: 20) {\n      nodes {\n        id\n        title\n        handle\n        featuredImage {\n          url\n          altText\n        }\n        priceRange {\n          minVariantPrice {\n            amount\n            currencyCode\n          }\n        }\n      }\n    }\n    shop {\n      name\n    }\n  }\n': {
    return: DashboardShopifyQuery;
    variables: DashboardShopifyQueryVariables;
  };
}
